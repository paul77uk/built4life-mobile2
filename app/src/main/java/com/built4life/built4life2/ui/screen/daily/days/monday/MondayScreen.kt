package com.built4life.built4life2.ui.screen.daily.days.monday
...
fun MondayScreen(
   workoutViewModel: WorkoutViewModel
    ...
    LaunchedEffect(key1 = true) {
        workoutViewModel.getMondayWorkouts()
    }

    val mondayWorkouts by workoutViewModel.mondayWorkouts.collectAsStateWithLifecycle()
